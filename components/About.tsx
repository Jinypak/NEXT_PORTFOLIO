  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        viewport={{ once: true }}
        src="https://velog.velcdn.com/images/jin_/profile/275de7f9-2925-47f1-932e-1d2ba1e55a39/social.jpeg"
      ...
      <div className="space-y-10 px-0 md:px-10">
        <h4 className="text-4xl font-semibold">
          I enjoy<br/>
          <span className="decoration-[#F7AB0A]/50 underline">watching SF Movies, foods.</span><br/>
          over the world
        </h4>
